...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-22 13:23`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a5ecf497-c909-4df8-9e09-f1b7eefa935a.git
$ cd a5ecf497-c909-4df8-9e09-f1b7eefa935a
```
